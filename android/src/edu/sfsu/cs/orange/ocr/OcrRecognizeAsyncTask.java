...
final class OcrRecognizeAsyncTask extends AsyncTask<Void, Void, Boolean> {
	...
	protected Boolean doInBackground(Void... arg0) {
		...
		//bitmap = WriteFile.writeBitmap(copyThresholdedImage);
		try {

			// Bitmap CroppedBitmap =
			// Bitmap.createBitmap(bitmap,0,0,bitmap.getWidth()/4,bitmap.getHeight());
			/*
			 * byte[] bm = CustomPreprocess.createBinaryImage(bitmap); int w =
			 ...
			 * ri.begin(); textResult=""; do{ String line =
			 * ri.getUTF8Text(PageIteratorLevel.RIL_TEXTLINE); textResult+=line;
