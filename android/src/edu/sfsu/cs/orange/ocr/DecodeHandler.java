...
final class DecodeHandler extends Handler {
    ...
    try {
    	...
    	//int scale = 2;
    	int newBitmapW=(int)((float)bitmapW/(float)scale);
    	int newBitmapH=(int)((float)bitmapH/(float)scale);
    	
    	Bitmap scaledBitmap = Bitmap.createScaledBitmap(bitmap, newBitmapW, newBitmapH, true);
    	*/
